...
public class R{
	...
	public static <E> Result success(int code,int total,E data) {
		String message = LoadPropertiesFileUtil.loadProperties(C.R, code);
	...
	public static <E> Result success(String fileName,int code,int total,E data) {
		String message = LoadPropertiesFileUtil.loadProperties(fileName, code);
		return new MessageTotalDataResult<E>(C.TYPE_RESULT_SUCCESS,code,message,total,data);
	}
	...
	public static <E> Result success(int code,String message,int total,E data) {
		return new MessageTotalDataResult<E>(C.TYPE_RESULT_SUCCESS,code,message,total,data);
	}
	...
	public static <E> Result fail(int code,int total,E data) {
		String message = LoadPropertiesFileUtil.loadProperties(C.R, code);
	...
	public static <E> Result fail(String fileName,int code,int total,E data) {
		String message = LoadPropertiesFileUtil.loadProperties(fileName, code);
		return new MessageTotalDataResult<E>(C.TYPE_RESULT_FAIL,code,message,total,data);
	}
	...
	public static <E> Result fail(int code,String message,int total,E data) {
		return new MessageTotalDataResult<E>(C.TYPE_RESULT_FAIL,code,message,total,data);
	}
	 ...
	 * 警告
	 */	
	public static Result warn(int code) {
		String message = LoadPropertiesFileUtil.loadProperties(C.R, code);
		return new MessageResult(C.TYPE_RESULT_WARN,code,message);
	}
	
	public static <E> Result warn(int code,E data) {
		String message = LoadPropertiesFileUtil.loadProperties(C.R, code);
		return new MessageDataResult<E>(C.TYPE_RESULT_WARN,code,message,data);
	}
	
	public static <E> Result warn(int code,int total,E data) {
		String message = LoadPropertiesFileUtil.loadProperties(C.R, code);
		return new MessageTotalDataResult<E>(C.TYPE_RESULT_WARN,code,message,total,data);
	}
	
	
	public static Result warn(String fileName,int code) {
		String message = LoadPropertiesFileUtil.loadProperties(fileName, code);
		return new MessageResult(C.TYPE_RESULT_WARN,code,message);
	}
	
	public static <E> Result warn(String fileName,int code,E data) {
		String message = LoadPropertiesFileUtil.loadProperties(fileName, code);
		return new MessageDataResult<E>(C.TYPE_RESULT_WARN,code,message,data);
	}
	public static <E> Result warn(String fileName,int code,int total,E data) {
		String message = LoadPropertiesFileUtil.loadProperties(fileName, code);
		return new MessageTotalDataResult<E>(C.TYPE_RESULT_WARN,code,message,total,data);
	}
	
	
	public static Result warn(int code,String message) {
		return new MessageResult(C.TYPE_RESULT_WARN,code,message);
	}
	
	public static <E> Result warn(int code,String message,E data) {
		return new MessageDataResult<E>(C.TYPE_RESULT_WARN,code,message,data);
	}
	
	public static <E> Result warn(int code,String message,int total,E data) {
		return new MessageTotalDataResult<E>(C.TYPE_RESULT_WARN,code,message,total,data);
	}
	 ...
	 * 信息
	 */
	public static Result info(int code) {
		String message = LoadPropertiesFileUtil.loadProperties(C.R, code);
		return new MessageResult(C.TYPE_RESULT_INFO,code,message);
	}
	
	public static <E> Result info(int code,E data) {
		String message = LoadPropertiesFileUtil.loadProperties(C.R, code);
		return new MessageDataResult<E>(C.TYPE_RESULT_INFO,code,message,data);
	}
	
	public static <E> Result info(int code,int total,E data) {
		String message = LoadPropertiesFileUtil.loadProperties(C.R, code);
		return new MessageTotalDataResult<E>(C.TYPE_RESULT_INFO,code,message,total,data);
	}
	
	
	public static Result info(String fileName,int code) {
		String message = LoadPropertiesFileUtil.loadProperties(fileName, code);
		return new MessageResult(C.TYPE_RESULT_INFO,code,message);
	}
	
	public static <E> Result info(String fileName,int code,E data) {
		String message = LoadPropertiesFileUtil.loadProperties(fileName, code);
		return new MessageDataResult<E>(C.TYPE_RESULT_INFO,code,message,data);
	}
	public static <E> Result info(String fileName,int code,int total,E data) {
		String message = LoadPropertiesFileUtil.loadProperties(fileName, code);
		return new MessageTotalDataResult<E>(C.TYPE_RESULT_INFO,code,message,total,data);
	}
	...
	public static <E> Result info(int code,String message,E data) {
		return new MessageDataResult<E>(C.TYPE_RESULT_INFO,code,message,data);
	}
	
	public static <E> Result info(int code,String message,int total,E data) {
		return new MessageTotalDataResult<E>(C.TYPE_RESULT_INFO,code,message,total,data);
	}
